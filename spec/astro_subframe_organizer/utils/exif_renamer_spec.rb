  ...
  module Utils
    describe ExifRenamer do
      ...
      describe '#already_named?' do
        # Expects: Light_Aurora_4.0s_Bin1_ISO6400_20210418-025606_20.0C_0441.CR2 — a file that does not start with IMG_
        context 'with already-renamed files' do
          it 'returns true' do
            files = [File.join(test_dir, 'Light_Aurora_4.0s_Bin1_ISO6400_20210418-025606_20.0C_0441.CR2')]
