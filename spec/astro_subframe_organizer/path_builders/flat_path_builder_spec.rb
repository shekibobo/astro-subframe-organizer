  ...
  module PathBuilders
    describe FlatPathBuilder, :files do
      context 'without rotation headers' do
        let(:path) { fixture('fits/flat-blanks/Flat_5.0s_Bin1_183MC_gain111_20240212-083938_-20.0C_0001.fit') }
        ...
        it 'builds a target directory path including matching keywords for Flat frames' do
          ...
          expect(target_dir).to eq('Flat_FLATSET_20240212_GAIN_111_EXP_5.0s_Bin_1_TELESCOPE_RedCat51_FILTER_BaaderMoon_CAMERA_ZWO ASI183MC Pro')
        end
      end
