...
class TestFilenameParser < Minitest::Test
  ...
  def test_filename_parser_factory_creates_fits_parser
    ...
    parser = AstroSubframeOrganizer::FilenameParser.for_file(path)

    assert_instance_of AstroSubframeOrganizer::FitsParser, parser
  end
  ...
  def test_filename_parser_factory_creates_cr2_parser
    ...
    assert_instance_of AstroSubframeOrganizer::CR2Parser, parser
  end
